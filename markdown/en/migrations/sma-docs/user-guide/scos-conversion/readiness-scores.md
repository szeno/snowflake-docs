...
- [Snowpark API Readiness Score](/migrations/sma-docs/user-guide/scos-conversion/readiness-scores)
- [Snowpark Connect Readiness Score](/migrations/sma-docs/user-guide/scos-conversion/readiness-scores)
- [Third Party API Readiness Score](/migrations/sma-docs/user-guide/scos-conversion/readiness-scores)
- [SQL Readiness Score](/migrations/sma-docs/user-guide/scos-conversion/readiness-scores)
...
This score is displayed as a percentage, indicating how well Snowflake supports the Spark API references found in your code. A higher percentage means better compatibility with Snowflake. You can view this score in both the [detailed report](/migrations/sma-docs/user-guide/scos-conversion/output-reports/curated-reports) and the [conversion summary](/migrations/sma-docs/user-guide/scos-conversion/understanding-the-conversion-summary) sections of the application.
...
The compatibility analysis yields a readiness score, which is categorized into one of three distinct levels: **Green**, **Yellow**, or **Red**. Both the application’s [conversion summary](/migrations/sma-docs/user-guide/scos-conversion/understanding-the-conversion-summary) and the generated [detailed report](/migrations/sma-docs/user-guide/scos-conversion/output-reports/curated-reports) will display this readiness level, accompanied by specific guidance tailored to the findings:
...
- Red - This workload has a significant number of references to the Spark API that are not supported in Snowpark Connect. However, this workload may still be a good candidate for conversion to the Snowpark API. The recommended next step would be to [convert this workload](/migrations/sma-docs/user-guide/snowpark-api-conversion/README), and take a look at the [Snowpark API Readiness Score](/migrations/sma-docs/user-guide/scos-conversion/readiness-scores). If you need help, feel free to reach out to [sma-support@snowflake.com](mailto:sma-support@snowflake.com).
