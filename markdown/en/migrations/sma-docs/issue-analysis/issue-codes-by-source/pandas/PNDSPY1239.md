...
**Reason:** N for axis = 1 or min\_periods = 0. N for string window with center = True. N for Timedelta or BaseIndexer window.
...
**Behavioral note**: N for axis = 1 or min\_periods = 0. N for string window with center = True. N for Timedelta or BaseIndexer window.
