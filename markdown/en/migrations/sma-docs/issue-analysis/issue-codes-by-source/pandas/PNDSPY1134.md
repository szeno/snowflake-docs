...
**Reason:** Implemented for DataframeGroupby objects. N for on, non-integer window, axis = 1, method != single, min\_periods = 0, or closed != None.
...
**Behavioral note**: Implemented for DataframeGroupby objects. N for on, non-integer window, axis = 1, method != single, min\_periods = 0, or closed != None.
