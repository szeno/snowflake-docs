...
**Reason:** N for non-integer window, axis = 1, pairwise = True, other = None, or min\_periods != window.
...
**Behavioral note**: N for non-integer window, axis = 1, pairwise = True, other = None, or min\_periods != window.
