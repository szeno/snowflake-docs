...
**Reason:** N if aggfunc is not a supported aggregation function <agg\_supp.html>\_, margins is True, normalize is “all” or True, and values is passed.
...
**Behavioral note**: N if aggfunc is not a supported aggregation function <agg\_supp.html>\_, margins is True, normalize is “all” or True, and values is passed.
