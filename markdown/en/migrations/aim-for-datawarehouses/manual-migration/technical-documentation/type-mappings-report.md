...
- [Data Type Customization](/migrations/aim-for-datawarehouses/code-conversion/translation-references/oracle/basic-elements-of-oracle-sql/data-types/README#data-type-customization): Learn how to configure data type transformation rules.
- [Oracle CLI Arguments](/migrations/aim-for-datawarehouses/manual-migration/oracle): Details on the `--dataTypeCustomizationFile` argument.
- [DB2 DECFLOAT](/migrations/aim-for-datawarehouses/code-conversion/translation-references/db2/db2-data-types#decfloat-data-type): Information about DECFLOAT transformation in DB2.
