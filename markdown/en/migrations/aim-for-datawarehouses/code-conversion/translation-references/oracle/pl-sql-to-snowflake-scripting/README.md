# Oracle - PL/SQL to Snowflake Scripting
...
3. [SSC-EWI-0062](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0062): Custom type usage changed to variant.
4. [SSC-EWI-OR0108](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0108): The Following Assignment Statement is Not Supported by Snowflake Scripting.
5. [SSC-FDM-0006](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0006): Number type column may not behave similarly in Snowflake.
6. [SSC-FDM-0007](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0007): Element with missing dependencies.
...
Review the following documentation about IF statements to learn more: [IF statements translation](#if) and [Snowflake IF statement documentation](https://docs.snowflake.com/en/sql-reference/snowflake-scripting/if)
...
Review the user-defined function (UDF) used [here](../built-in-packages#put_line-procedure).
...
For more information, review the following documentation: [CASE statement documentation](#case) and [Snowflake CASE documentation](https://docs.snowflake.com/en/sql-reference/snowflake-scripting/case)
...
For more information review the following documentation: [FOR LOOP](#for-loop) and Snowflake [LOOP documentation](https://docs.snowflake.com/en/sql-reference/snowflake-scripting/loop) and [FOR documentation](https://docs.snowflake.com/en/sql-reference/snowflake-scripting/for).
...
Anonymous block in Oracle may have calls to procedures. Furthermore, the following documentation may be useful: [Procedure documentation](./create-procedure).

The following example uses the OUT parameters, the information about the current transformation can be found here: [OUTPUT Parameters](#output-parameters)
...
For more information, review the following documentation: [Alter session documentation](../sql-translation-reference/README#alter-session).
...
1. [SSC-EWI-0027](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0027):The following statement uses a variable/literal with an invalid query and it will not be executed.
2. [SSC-EWI-OR0036](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0036): Types resolution issues, the arithmetic operation may not behave correctly between string and date.
3. [SSC-FDM-OR0035](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0035): DBMS\_OUTPUT.PUTLINE check UDF implementation.
4. [SSC-FDM-0006](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0006): Number type column may not behave similarly in Snowflake.
5. [SSC-PRF-0004](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0004): This statement has usages of cursor for loop.
6. [SSC-EWI-0030](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0030): The statement below has usages of dynamic SQL
...
1. [SSC-EWI-OR0051](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0051): PRAGMA EXCEPTION\_INIT is not supported.
2. [SSC-EWI-OR0099](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0099): The exception code exceeds the Snowflake Scripting limit.
3. [SSC-FDM-0016](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0016): Constants are not supported by Snowflake Scripting. It was transformed into a variable.
4. [SSC-FDM-OR0025](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0025): Not Null constraint is not supported in Snowflake Procedures.
...
A **default parameter** is a parameter that has a value in case an argument is not passed in the procedure or function call. Since Snowflake doesn’t support default parameters, the default value is inserted in the procedure or function call.
...
Numeric Names for placeholders are currently not being recognized, but there is a work item to fix this issue.
...
1. [SSC-EWI-0027](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0027): Variable with invalid query.
2. [SSC-EWI-0030](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0030): The statement below has usages of dynamic SQL.
...
1. [SSC-FDM-0016](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0016): Constants are not supported by Snowflake Scripting. It was transformed to a variable.
...
Oracle allows additional clauses to the `FOR LOOP` condition. Like the **BY** clause for a stepped increment in the condition. And the **WHILE** and **WHEN** clause for boolean expressions. These additional clauses are not supported in Snowflake Scripting and are ignored during transformation. Check [SSC-EWI-OR0101](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0101).
...
3. [SSC-EWI-OR0100](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0100): For Loop With Multiple Conditions Is Currently Not Supported By Snowflake Scripting. Only First Condition Is Used.
4. [SSC-EWI-OR0101](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0101): Specific For Loop Clause Is Currently Not Supported By Snowflake Scripting.
5. [SSC-EWI-OR0103](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0103): For Loop Format Is Currently Not Supported By Snowflake Scripting.
...
You might also be interested in [Bulk Cursor Helpers](helpers#bulk-cursor-helpers).
...
3. [SSC-EWI-0056](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0056): Create Type Not Supported.
4. [SSC-EWI-0058](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0058): Functionality is not currently supported by Snowflake Scripting.
5. [SSC-EWI-0062](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0062): Custom type usage changed to variant.
6. [SSC-EWI-OR0049](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0049): Package constants in stateful package are not supported yet.
7. [SSC-FDM-0006](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0006): Number type column may not behave similarly in Snowflake.
8. [SSC-FDM-0015:](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0015) ​Referenced custom type in query not found.
9. [SSC-PRF-0001](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0001): This statement has usages of cursor fetch bulk operations.
10. [SSC-PRF-0003](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0003): Fetch inside a loop is considered a complex pattern, this could degrade Snowflake performance.
...
[nested-table-array-type-definition.md](collections-and-records#nested-table-array-type-definition)

[nested-table-type-definition.md](../sql-translation-reference/create_type#nested-table-type-definition)
...
[object-type-definition.md](../sql-translation-reference/create_type#object-type-definition)
...
4. [SSC-EWI-OR0035](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0035): The table function is not supported when it is used as a collection of expressions.
5. [SSC-FDM-0006](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0006): Number type column may not behave similarly in Snowflake.
6. [SSC-FDM-0015:](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0015) ​Referenced custom type in query not found.
7. [SSC-FDM-OR0035](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0035): DBMS\_OUTPUT.PUTLINE check UDF implementation.
...
1. [SSC-EWI-0030](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0030): The statement below has usages of dynamic SQL.
2. [SSC-EWI-0036](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0036): Data type converted to another data type.
3. [SSC-EWI-0058](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0058): Functionality is not currently supported by Snowflake Scripting.
4. [SSC-EWI-0062](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0062): Custom type usage changed to variant.
5. [SSC-EWI-OR0129](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0129): TYPE attribute could not be resolved.
6. [SSC-FDM-0006](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0006): Number type column may not behave similarly in Snowflake.
7. [SSC-FDM-OR0031:](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0031) The error logging clause in DML statements is not supported by Snowflake.
8. [SSC-PRF-0001](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0001): This statement has usages of cursor fetch bulk operations.
9. [SSC-PRF-0003](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0003): Fetch inside a loop is considered a complex pattern, this could degrade Snowflake performance.
...
2. [SSC-FDM-0007](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0007): Element with missing dependencies.
3. [SSC-FDM-0015](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0015): Data Type Not Recognized.
...
Nested procedure arguments do not support default clauses. Therefore, if a nested procedure call omits an optional parameter, the default value for that argument must be submitted within the procedure call. These scenarios are automatically identified and the procedure calls are filled appropriately.
...
In Snowflake, a nested procedure definition requires empty parentheses `()` to be syntactically valid when it has no parameters; contrary to Oracle, where they are not needed. These will be added automatically during translation.
...
1. [SSC-FDM-OR0050](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0050): Exceptions with `NOCOPY` parameters may lead to data inconsistency.
2. [SSC-EWI-OR0057](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0057): Transformation for nested procedure or function is not supported.
3. [SSC-EWI-0111](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0111): Only one level of nesting is allowed for nested procedures in Snowflake.
4. [SSC-EWI-0112](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0112): Nested procedure overloading is not supported.
...
Snowflake requires default parameters to appear at the end of the parameter list. They are automatically reordered and an [SSC-FDM-0041](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0041) notice is emitted. When positional callers are detected, they are converted to named arguments.

##### 2. Named parameters are accepted, but not functionally equivalent

Named parameters are supported in Snowflake. When default parameters are reordered, positional call sites are automatically converted to use named arguments to preserve the original semantics.
...
1. [SSC-FDM-0041](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0041): Default parameters were reordered to the end of the parameter list.
2. [SSC-FDM-0007](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0007): Element with missing dependencies.
...
1. [SSC-EWI-OR0099](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0099): The exception code exceeds the Snowflake Scripting limit.
2. [SSC-FDM-0029](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0029): User defined function was transformed to a Snowflake procedure.
3. [SSC-FDM-OR0011](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0011): The boolean argument was removed because the “add to stack” options is not supported.
...
3. [SSC-FDM-0029](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0029): User defined function was transformed to a Snowflake procedure.
