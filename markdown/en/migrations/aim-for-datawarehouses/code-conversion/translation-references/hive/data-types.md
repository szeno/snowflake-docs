...
| INTERVAL | VARCHAR(30) | INTERVAL data type is **not supported** in Snowflake. VARCHAR is used instead. With the `--UseIntervalDatatype` preview flag, maps to native Snowflake INTERVAL types. See [Interval Data Types](../general/interval-data-types). |
