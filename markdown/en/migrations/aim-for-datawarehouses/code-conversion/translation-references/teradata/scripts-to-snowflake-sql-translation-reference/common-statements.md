...
1. [SSC-FDM-TD0013](../../../issues-and-troubleshooting/functional-difference/teradataFDM#ssc-fdm-td0013): The Snowflake error code mismatches the original Teradata error code.
...
When the EXIT or QUIT command doesn’t have an input, it returns the ERRORLEVEL as default. However, it is transformed to return 0.
...
2. [SSC-FDM-0027](../../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0027): Removed next statement, not applicable in Snowflake.
...
4. [SSC-FDM-TD0026](../../../issues-and-troubleshooting/functional-difference/teradataFDM#ssc-fdm-td0026): GOTO statement was removed due to if statement inversion.
