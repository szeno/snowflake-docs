...
1. The behavior of fixed char types may differ. See [Known issues](#known-issues) for more information.
...
2. If these patterns are stored in a variable, the necessary adjustments for equivalence are not applied.
