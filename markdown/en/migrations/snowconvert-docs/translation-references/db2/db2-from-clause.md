...
[![image](/static/images/migrations/sc-assets/from_clause_overview.png "image")](/static/images/migrations/sc-assets/from_clause_overview.png)
...
[![image](/static/images/migrations/sc-assets/table_reference_syntax.png "image")](/static/images/migrations/sc-assets/table_reference_syntax.png)
...
[![image](/static/images/migrations/sc-assets/analyze_table_syntax.png "image")](/static/images/migrations/sc-assets/analyze_table_syntax.png)
...
1. [SSC-EWI-DB0019](../../issues-and-troubleshooting/conversion-issues/db2EWI): ANALYZE TABLE FACTOR IS NOT SUPPORTED
...
[![image](/static/images/migrations/sc-assets/collection_derived_table_syntax_1.png "image")](/static/images/migrations/sc-assets/collection_derived_table_syntax_1.png)

[![image](/static/images/migrations/sc-assets/collection_derived_table_syntax_2.png "image")](/static/images/migrations/sc-assets/collection_derived_table_syntax_2.png)
...
1. [SSC-EWI-DB0016](../../issues-and-troubleshooting/conversion-issues/db2EWI): UNNEST FUNCTION IS NOT SUPPORTED
...
[![image](/static/images/migrations/sc-assets/data_change_table_syntax.png "image")](/static/images/migrations/sc-assets/data_change_table_syntax.png)
...
1. [SSC-EWI-DB0006](../../issues-and-troubleshooting/conversion-issues/db2EWI#ssc-ewi-db0006): INTERMEDIATE RESULT TABLE IS NOT SUPPORTED.
...
[![image](/static/images/migrations/sc-assets/external_table_syntax.png "image")](/static/images/migrations/sc-assets/external_table_syntax.png)
...
1. [SSC-EWI-DB0014](../../issues-and-troubleshooting/conversion-issues/db2EWI#ssc-ewi-db0014): THE USE OF EXTERNAL TABLE REFERENCES IS NOT SUPPORTED IN SNOWFLAKE
...
[![image](/static/images/migrations/sc-assets/nested_table_syntax.png "image")](/static/images/migrations/sc-assets/nested_table_syntax.png)
...
1. [SSC-FDM-0027](../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0027): REMOVED NEXT STATEMENT, NOT APPLICABLE IN SNOWFLAKE.
...
[![image](/static/images/migrations/sc-assets/only_table_syntax.png "image")](/static/images/migrations/sc-assets/only_table_syntax.png)
...
[![image](/static/images/migrations/sc-assets/outer_table_syntax.png "image")](/static/images/migrations/sc-assets/outer_table_syntax.png)
...
1. [SSC-EWI-DB0004](../../issues-and-troubleshooting/conversion-issues/db2EWI#ssc-ewi-db0004): OUTER TABLE REFERENCE IS NOT SUPPORTED IN SNOWFLAKE.
...
[![image](/static/images/migrations/sc-assets/period_specification_syntax.png "image")](/static/images/migrations/sc-assets/period_specification_syntax.png)
...
1. [SSC-EWI-DB0003](../../issues-and-troubleshooting/conversion-issues/db2EWI#ssc-ewi-db0003): PERIOD SPECIFICATION IS NOT SUPPORTED IN SNOWFLAKE.
...
[![image](/static/images/migrations/sc-assets/table_function_syntax_1.png "image")](/static/images/migrations/sc-assets/table_function_syntax_1.png)

[![image](/static/images/migrations/sc-assets/table_function_syntax_2.png "image")](/static/images/migrations/sc-assets/table_function_syntax_2.png)
