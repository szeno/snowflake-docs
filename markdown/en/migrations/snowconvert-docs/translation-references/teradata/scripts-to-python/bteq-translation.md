...
Every SQL statement found in a BTEQ file will be executed through the`exec`function provided by the [snowconvert.helpers](snowconvert-script-helpers). Take for example the following code:
