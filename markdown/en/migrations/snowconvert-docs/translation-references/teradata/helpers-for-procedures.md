...
Depending on what is in each Stored Procedure in Teradata, One or more of the following javascript functions will be created inside them.
...
var CompareDates = function (value1, value2) {
  ...
  if (value1Time == null && value2Time == null)
    return null; /*in SQL null == null is equal to null as well as any other comparison */
