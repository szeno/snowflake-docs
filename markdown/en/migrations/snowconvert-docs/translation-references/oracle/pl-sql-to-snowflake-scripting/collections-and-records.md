...
As of now, no differentiation is made between an Associative Array and a Nested Table meaning they are mixed up in the same assessment counts.
...
These collections are treated as Nested Table Arrays. There is a work item to fix this.
...
| [FIRST](#firstlast) | Not Recognized. | Not Translated. | UDF |
| [LAST](#firstlast) | Not Recognized. | Not Translated. | UDF |
...
| [PRIOR](#priornext) | Not Recognized. | Not Translated. | UDF (To be defined) |
| [NEXT](#priornext) | Not Recognized. | Not Translated. | UDF (To be defined) |
...
This section is for the PL/SQL Version of the Nested Table Arrays, for the Standalone Version please see [Nested Table Type Definition](../sql-translation-reference/create_type#nested-table-type-definition).
...
Translating these elements is not supported.
...
5. [SSC-FDM-OR0035](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0035): DBMS\_OUTPUT.PUTLINE check UDF implementation.
6. [SSC-PRF-0003](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0003): Fetch inside a loop is considered a complex pattern, this could degrade Snowflake performance.
...
This section is for the PL/SQL Version of the Varrays, for the Standalone Version please see [Array Type Definition](../sql-translation-reference/create_type#array-type-definition).
...
They are not supported but may be manually changed to SELECT statements.
...
2. [SSC-EWI-0062](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0062): Custom type usage changed to variant.
3. [SSC-EWI-0073](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0073): Pending Functional Equivalence Review
4. [SSC-EWI-OR0036](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0036): Types resolution issues, the arithmetic operation may not behave correctly between string and date.
5. [SSC-EWI-OR0108](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0108): The Following Assignment Statement is Not Supported by Snowflake Scripting.
6. [SSC-FDM-OR0035](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0035): DBMS\_OUTPUT.PUTLINE check UDF implementation.
7. [SSC-PRF-0001](../../../issues-and-troubleshooting/performance-review/generalPRF#ssc-prf-0001): This statement has usages of cursor fetch bulk operations.
8. [SSC-EWI-0030](../../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0030): The statement below has usages of dynamic SQL
...
- [Bulk Collect translation](#bulk-collect-from-a-table).
...
6. [SSC-EWI-OR0104](../../../issues-and-troubleshooting/conversion-issues/oracleEWI#ssc-ewi-or0104): Unusable collection variable.
...
8. [SSC-FDM-OR0035](../../../issues-and-troubleshooting/functional-difference/oracleFDM#ssc-fdm-or0035): DBMS\_OUTPUT.PUTLINE check UDF implementation.
