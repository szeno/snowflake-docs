...
Current Data types conversion for Redshift.
...
| BPCHAR | VARCHAR | BPCHAR data type is **not supported** in Snowflake. VARCHAR is used instead. For more information please refer to [SSC-FDM-PG0002](../../issues-and-troubleshooting/functional-difference/postgresqlFDM#ssc-fdm-pg0002). |
...
| TIMETZ | TIME | Time zone not supported for time data type. For more information please refer to [SSC-FDM-0005](../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0005). |
| TIME WITH TIME ZONE | TIME | Time zone not supported for time data type. For more information please refer to [SSC-FDM-0005](../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0005). |
...
| TIMESTAMPTZ | TIMESTAMP\_TZ | TIMESTAMP*TZ internally stores UTC time together with an associated \_time zone offset*. |
| TIMESTAMP WITH TIME ZONE | TIMESTAMP\_TZ | TIMESTAMP*TZ internally stores UTC time together with an associated \_time zone offset*. |
| TIMESTAMP WITHOUT TIME ZONE | TIMESTAMP\_NTZ | TIMESTAMP\_NTZ internally stores “wallclock” time with a specified precision. |
| INTERVAL YEAR TO MONTH | VARCHAR | The interval data type is not supported by Snowflake. Transformed to VARCHAR. With the `--UseIntervalDatatype` preview flag, preserved as native `INTERVAL YEAR TO MONTH`. See [Interval Data Types](../general/interval-data-types). |
| INTERVAL DAY TO SECOND | VARCHAR | The interval data type is not supported by Snowflake. Transformed to VARCHAR. With the `--UseIntervalDatatype` preview flag, preserved as native `INTERVAL DAY TO SECOND`. See [Interval Data Types](../general/interval-data-types). |
...
| HLLSKETCH | N/A | Data type not supported in Snowflake. For more information please refer to [SSC-EWI-RS0004](../../issues-and-troubleshooting/conversion-issues/redshiftEWI#ssc-ewi-rs0004). |
...
2. [SSC-FDM-0005](../../issues-and-troubleshooting/functional-difference/generalFDM#ssc-fdm-0005): TIME ZONE not supported for time data type.
3. [SSC-EWI-0036](../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0036): Data type converted to another data type.
4. [SSC-EWI-RS0004](../../issues-and-troubleshooting/conversion-issues/redshiftEWI#ssc-ewi-rs0004): HLLSKETCH data type not supported in Snowflake.
...
**Preview Feature:** When the `--UseIntervalDatatype` preview flag is enabled, Redshift INTERVAL columns are preserved as native Snowflake INTERVAL types. See the [Interval Data Types](../general/interval-data-types) translation reference for complete transformation details.
...
- [SSC-EWI-0036](../../issues-and-troubleshooting/conversion-issues/generalEWI#ssc-ewi-0036): Data type converted to another data type.
