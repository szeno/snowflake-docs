...
- [SSC-EWI-RS0007](../../issues-and-troubleshooting/conversion-issues/redshiftEWI#ssc-ewi-rs0008): Date literal is not supported in Snowflake.
...
The following formats are the only ones recognized and fully transformed, allowing optional fields and most of the abbreviations without interval styles:
