...
This Organization Usage view displays a row for each view in an account, not including the views in the ACCOUNT\_USAGE,
READER\_ACCOUNT\_USAGE, and INFORMATION\_SCHEMA schemas.

See also:
:   [TABLES view](/sql-reference/organization-usage/tables)
