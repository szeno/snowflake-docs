...
See also:
:   [COLUMNS view](/sql-reference/organization-usage/columns) , [VIEWS view](/sql-reference/organization-usage/views), [TABLES view](/sql-reference/info-schema/tables) (Information Schema)
