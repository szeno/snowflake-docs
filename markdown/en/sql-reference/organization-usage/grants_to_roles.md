...
For more information about how to use this view, see [Monitoring access control privileges in your account](/user-guide/security-access-control-considerations#label-security-considerations-monitoring).
