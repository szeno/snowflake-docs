...
You can use this view in combination with the [COLUMN\_QUERY\_PRUNING\_HISTORY view](/sql-reference/organization-usage/column_query_pruning_history). For example,
