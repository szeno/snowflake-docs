...
See also:
:   [SYSTEM$REVOKE\_PRIVATELINK](/sql-reference/functions/system_revoke_privatelink) , [SYSTEM$GET\_PRIVATELINK](/sql-reference/functions/system_get_privatelink) ,
...
- Call the [SYSTEM$REVOKE\_PRIVATELINK](/sql-reference/functions/system_revoke_privatelink) function disable your Snowflake account to use private
