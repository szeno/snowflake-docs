...
# H3\_POINT\_TO\_CELL\_STRING

Returns the hexadecimal value of an [H3](/sql-reference/data-types-geospatial#label-data-types-geospatial-h3) cell ID for a Point (specified by a
[GEOGRAPHY](/sql-reference/data-types-geospatial#label-data-types-geography) object) at a given resolution.

See also:
:   [H3\_POINT\_TO\_CELL](/sql-reference/functions/h3_point_to_cell) , [H3\_CELL\_TO\_POINT](/sql-reference/functions/h3_cell_to_point)
