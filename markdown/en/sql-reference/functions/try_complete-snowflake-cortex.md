...
Performs the same operation as the [COMPLETE](/sql-reference/functions/complete-snowflake-cortex) function
...
TRY\_COMPLETE does not retain any state from one call to the next. To use the TRY\_COMPLETE function to provide a stateful,
