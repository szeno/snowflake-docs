...
[GEOMETRY](/sql-reference/data-types-geospatial#label-data-types-geometry) objects intersect (i.e. share any portion of space).
...
This shows a simple use of the ST\_INTERSECTS function:
