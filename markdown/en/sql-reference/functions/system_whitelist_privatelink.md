...
# SYSTEM$WHITELIST\_PRIVATELINK — *Deprecated*

Deprecated Feature

This function has been deprecated. Use [SYSTEM$ALLOWLIST\_PRIVATELINK](/sql-reference/functions/system_allowlist_privatelink) instead.
