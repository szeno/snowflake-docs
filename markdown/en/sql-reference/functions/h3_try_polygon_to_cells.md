...
# H3\_TRY\_POLYGON\_TO\_CELLS

A special version of [H3\_POLYGON\_TO\_CELLS](/sql-reference/functions/h3_polygon_to_cells) that returns NULL if an error
occurs when it attempts to return an [array](/sql-reference/data-types-semistructured#label-data-type-array) of INTEGER values of the IDs of
...
See [H3\_POLYGON\_TO\_CELLS](/sql-reference/functions/h3_polygon_to_cells) for the usage notes.

## Examples

The following example attempts to return an array of INTEGER values of the IDs of [H3](/sql-reference/data-types-geospatial#label-data-types-geospatial-h3)
...
For examples that successfully return an array of IDs, see [H3\_POLYGON\_TO\_CELLS](/sql-reference/functions/h3_polygon_to_cells).
