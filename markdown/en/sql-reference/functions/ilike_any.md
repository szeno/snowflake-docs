...
See also:
:   [[ NOT ] LIKE](/sql-reference/functions/like) , [[ NOT ] ILIKE](/sql-reference/functions/ilike) , [LIKE ANY](/sql-reference/functions/like_any)
...
For examples of how to escape wildcard characters, see [LIKE ANY](/sql-reference/functions/like_any).
