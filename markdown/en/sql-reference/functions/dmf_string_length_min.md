...
# STRING\_LENGTH\_MIN (system data metric function)
...
Returns the minimum string length of non-NULL values for the specified column in a table. Use this function to detect truncation
or unexpectedly short values.
