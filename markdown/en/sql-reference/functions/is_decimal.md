...
[fixed-point number or integer](/sql-reference/data-types-numeric#label-data-types-for-fixed-point-numbers) value.

See also:
:   [IS\_\*<object\_type>\*](/sql-reference/functions/is) , [IS\_DOUBLE , IS\_REAL](/sql-reference/functions/is_double-real) , [IS\_INTEGER](/sql-reference/functions/is_integer)
...
The following examples use the IS\_DECIMAL function.

### Use the IS\_DECIMAL function in a WHERE clause
...
Show the fixed-point number and integer values in the data by using the IS\_DECIMAL function
in a WHERE clause:
...
### Use the IS\_DECIMAL function in a SELECT list
...
IS\_DECIMAL function in a SELECT list:
