...
Returns TRUE if its [VARIANT](/sql-reference/data-types-semistructured#label-data-type-variant) argument contains an [ARRAY](/sql-reference/data-types-semistructured#label-data-type-array) value.

See also:
:   [IS\_\*<object\_type>\*](/sql-reference/functions/is) , [IS\_OBJECT](/sql-reference/functions/is_object)
...
### Use the IS\_ARRAY function in a WHERE clause
...
### Use the IS\_ARRAY function in a SELECT list
