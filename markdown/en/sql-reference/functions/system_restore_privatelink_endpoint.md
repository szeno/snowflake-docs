...
# SYSTEM$RESTORE\_PRIVATELINK\_ENDPOINT
...
recreate the endpoint with the [SYSTEM$PROVISION\_PRIVATELINK\_ENDPOINT](/sql-reference/functions/system_provision_privatelink_endpoint) system function.
