...
Returns TRUE if its [VARIANT](/sql-reference/data-types-semistructured#label-data-type-variant) argument contains a [BOOLEAN](/sql-reference/data-types-logical#label-data-type-boolean) value.
...
### Use the IS\_BOOLEAN function in a WHERE clause
...
### Use the IS\_BOOLEAN function in a SELECT list
