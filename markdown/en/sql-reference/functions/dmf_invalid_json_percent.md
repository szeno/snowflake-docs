...
# INVALID\_JSON\_PERCENT (system data metric function)
...
Returns the percentage of non-NULL column values that are not valid JSON. The percentage is computed over the total row count,
