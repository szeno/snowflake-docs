# ANOMALY\_INSIGHTS!SET\_ORG\_NOTIFICATION\_EMAILS

Defines the list of email addresses that will receive a notification when there is an
[organization-level cost anomaly](/user-guide/cost-anomalies#label-cost-anomaly-level).

An organization-level anomaly occurs when the aggregate consumption of all accounts falls outside an expected range. If you want to define
