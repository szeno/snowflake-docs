# <budget\_name>!REMOVE\_TAG

Removes a tag/value combination from a custom budget. The tag must be removed by [reference](/sql-reference/references).

Important

This method has been deprecated. Use [<budget\_name>!SET\_RESOURCE\_TAGS](/sql-reference/classes/budget/methods/set_resource_tags) instead.
