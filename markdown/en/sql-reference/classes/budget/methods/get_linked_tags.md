# <budget\_name>!GET\_LINKED\_TAGS

List the tags that have been added to a [custom budget](/user-guide/budgets).

Important

This method has been deprecated. Use [<budget\_name>!GET\_BUDGET\_SCOPE](/sql-reference/classes/budget/methods/get_budget_scope) instead.
