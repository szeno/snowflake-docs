# <classification\_profile\_name>!UNSET\_SNOWFLAKE\_SEMANTIC\_CATEGORIES
...
Removes the semantic category restrictions from the classification profile so that all [native semantic categories](/user-guide/classify-native) are used during classification.
