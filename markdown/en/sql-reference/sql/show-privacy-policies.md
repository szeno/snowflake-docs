...
Lists the [privacy policies](/user-guide/diff-privacy/differential-privacy-admin-privacy-policies) for which you have access privileges.
...
See also:
:   [CREATE PRIVACY POLICY](/sql-reference/sql/create-privacy-policy) , [ALTER PRIVACY POLICY](/sql-reference/sql/alter-privacy-policy) , [DESCRIBE PRIVACY POLICY](/sql-reference/sql/desc-privacy-policy) , [DROP PRIVACY POLICY](/sql-reference/sql/drop-privacy-policy)
