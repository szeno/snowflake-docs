...
See also:
:   [CREATE NOTIFICATION INTEGRATION (outbound to a Google Pub/Sub topic)](/sql-reference/sql/create-notification-integration-queue-outbound-gcp) , [DESCRIBE NOTIFICATION INTEGRATION](/sql-reference/sql/desc-notification-integration) , [DROP INTEGRATION](/sql-reference/sql/drop-integration) ,
