...
See also:
:   [SEQUENCES view](/sql-reference/info-schema/sequences) (Information Schema) , [CREATE SEQUENCE](/sql-reference/sql/create-sequence) , [ALTER SEQUENCE](/sql-reference/sql/alter-sequence) , [DROP SEQUENCE](/sql-reference/sql/drop-sequence) ,
