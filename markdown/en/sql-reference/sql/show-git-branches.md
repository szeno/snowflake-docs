...
See also:
:   [SHOW GIT TAGS](/sql-reference/sql/show-git-tags), [CREATE GIT REPOSITORY](/sql-reference/sql/create-git-repository), [SHOW GIT REPOSITORIES](/sql-reference/sql/show-git-repositories)
