...
Lists the [workspaces](/user-guide/ui-snowsight/workspaces) for which you have access privileges. Each workspace is associated with a specific database and schema, allowing for organized data access and collaboration.

For step-by-step workspace lifecycle operations using SQL (for example, `CREATE WORKSPACE` and file staging commands), see [Workspace operations using SQL](/user-guide/ui-snowsight/workspaces-sql).
