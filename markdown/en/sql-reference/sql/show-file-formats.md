...
See also:
:   [CREATE FILE FORMAT](/sql-reference/sql/create-file-format) , [DROP FILE FORMAT](/sql-reference/sql/drop-file-format) , [ALTER FILE FORMAT](/sql-reference/sql/alter-file-format) , [DESCRIBE FILE FORMAT](/sql-reference/sql/desc-file-format)
...
| Column | Description |
| --- | --- |
| format\_options | Values of all options for the file format type. Returns the default value for any option that is not explicitly defined. |
| created\_on | Date and time when the file format was created. |
| name | Name of the file format. |
| database\_name | Database in which the file format is stored. |
| schema\_name | Schema in which the file format is stored. |
