...
Lists the [experiments](/developer-guide/snowflake-ml/experiments) for which you have access privileges.
...
See also:
:   [CREATE EXPERIMENT](/sql-reference/sql/create-experiment) , [ALTER EXPERIMENT](/sql-reference/sql/alter-experiment), [SHOW RUNS IN EXPERIMENT](/sql-reference/sql/show-runs-in-experiment) , [DROP EXPERIMENT](/sql-reference/sql/drop-experiment), [SHOW RUN … IN EXPERIMENT](/sql-reference/sql/show-run-in-experiment)
