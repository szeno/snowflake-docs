...
See also:
:   [ALTER SECRET](/sql-reference/sql/alter-secret) , [CREATE SECRET](/sql-reference/sql/create-secret) , [DESCRIBE SECRET](/sql-reference/sql/desc-secret) , [DROP SECRET](/sql-reference/sql/drop-secret)
