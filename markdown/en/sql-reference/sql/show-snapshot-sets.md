...
The SHOW SNAPSHOT SETS command is deprecated. See [SHOW BACKUP SETS](/sql-reference/sql/show-backup-sets).

Lists all the [snapshot](/user-guide/backups) sets for which you have access privileges.
