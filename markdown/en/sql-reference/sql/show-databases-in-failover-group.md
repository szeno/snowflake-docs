...
Lists databases in a [failover group](/user-guide/account-replication-intro#label-replication-and-failover-groups).

See also:
:   [SHOW LISTINGS IN FAILOVER GROUP](/sql-reference/sql/show-listings-in-failover-group), [SHOW SHARES IN FAILOVER GROUP](/sql-reference/sql/show-shares-in-failover-group)
