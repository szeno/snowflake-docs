...
Lists the [notebooks](/user-guide/ui-snowsight/notebooks) for which you have access privileges.
...
and object name (see [Output](#output) in this topic for descriptions of the output columns). The order is important to note if you want to
filter the results.
