...
Lists the metrics in the [semantic views](/user-guide/views-semantic/overview) for which you have access privileges.
...
| --- | --- | --- |
| Any | Semantic view |  |
| REFERENCES or OWNERSHIP | Semantic view | One of these privileges is required if you want the output to include [private metrics](/user-guide/views-semantic/sql#label-semantic-views-private). |
