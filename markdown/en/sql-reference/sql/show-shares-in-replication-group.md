...
Lists shares in a [replication group](/user-guide/account-replication-intro#label-replication-and-failover-groups).

See also:
:   [SHOW DATABASES IN REPLICATION GROUP](/sql-reference/sql/show-databases-in-replication-group)
...
- To retrieve the list of replication groups in your organization, use [SHOW REPLICATION GROUPS](/sql-reference/sql/show-replication-groups).
