...
> - [CREATE OR ALTER PIPE](/sql-reference/sql/create-pipe#label-create-or-alter-pipe-syntax)
...
> - [CREATE OR ALTER STREAM](/sql-reference/sql/create-stream#label-create-or-alter-stream-syntax)
