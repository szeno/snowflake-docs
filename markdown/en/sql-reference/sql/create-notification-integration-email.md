...
See also:
:   [ALTER NOTIFICATION INTEGRATION (email)](/sql-reference/sql/alter-notification-integration-email) , [DESCRIBE NOTIFICATION INTEGRATION](/sql-reference/sql/desc-notification-integration) , [DROP INTEGRATION](/sql-reference/sql/drop-integration) ,
...
See [Sending email notifications](/user-guide/notifications/email-notifications).
