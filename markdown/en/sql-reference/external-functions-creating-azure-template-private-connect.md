...
2. Complete the [prerequisites](/sql-reference/external-functions-creating-azure-planning) for external functions on Microsoft
   Azure.
3. In the Azure Portal, [create an application](/sql-reference/external-functions-creating-azure-template-apps).
...
5. Continue with these steps:
   ...
   1. [Create the Azure function and API Management service](/sql-reference/external-functions-creating-azure-template-services#label-external-functions-azure-create-function-api-mgmt-service).
   2. [Obtain the required URLs for the API integration and external function](/sql-reference/external-functions-creating-azure-template-services#label-external-functions-azure-get-urls).
