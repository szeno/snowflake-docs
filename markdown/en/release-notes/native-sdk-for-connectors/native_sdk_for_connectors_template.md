...
- Updated the template to the [newest SDK release](/release-notes/native-sdk-for-connectors/native_sdk_for_connectors_java#label-connectors-java-library-v2-2-0).
