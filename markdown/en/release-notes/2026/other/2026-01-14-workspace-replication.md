...
Workspaces replication, which allows user workspaces to be included in database replication and failover operations, is now available in [preview](/release-notes/preview-features).
