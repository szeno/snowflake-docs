...
Shared workspaces are now available in [preview](/release-notes/preview-features). Shared workspaces introduce collaborative development
...
For details, see [Shared workspaces](/user-guide/ui-snowsight/workspaces-shared).
