...
For more information, see [- [](/sql-reference/sql/create-dynamic-table#label-create-dt-iceberg-syntax)](/user-guide/dynamic-tables/create-iceberg#label-create-dt-from-iceberg)
