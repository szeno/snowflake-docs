...
If you are using a development environment not covered earlier (see [Setting Up Your Development Environment for Snowpark Java](/developer-guide/snowpark/java/setup)), see the instructions in this topic for
