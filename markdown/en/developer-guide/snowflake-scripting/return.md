...
To return a value, use the [RETURN](/sql-reference/snowflake-scripting/return) command. You can return a
...
- A table
  ...
  If you want to return the data that a [RESULTSET](/developer-guide/snowflake-scripting/resultsets) points to, pass the RESULTSET to
...
See [Snowflake Scripting UDFs](/developer-guide/udf/sql/udf-sql-procedural-functions).
