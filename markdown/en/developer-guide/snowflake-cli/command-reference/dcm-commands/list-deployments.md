...
`identifier`
:   Identifier of a DCM Project. Example: MY\_DB.MY\_SCHEMA.MY\_PROJECT. Supports fully qualified (recommended) or simple names. If unqualified, it defaults to the connection’s database and schema. Optional if *–target* or *default\_target* is defined in the manifest.
...
:   Value of the client ID provided by the Identity Provider for Snowflake integration.
