...
`--auto-resume`
:   Reset the AUTO\_RESUME property - The compute pool will automatically resume when a service or job is submitted to it. Default: False.

`--auto-suspend-secs`
:   Reset the AUTO\_SUSPEND\_SECS property - Number of seconds of inactivity after which you want Snowflake to automatically suspend the compute pool. Default: False.
