...
The `snow spcs image repository deploy` command creates an image repository from its definition in a `snowflake.yml` project definition file. For more information, see [Image repository project definition file](/developer-guide/snowflake-cli/services/manage-images#label-sfcli-repo-pdf).
