...
`--force`
:   Force the drop even if the service contains block storage volumes. Without this option, the command fails when block storage volumes are attached. Default: False.
