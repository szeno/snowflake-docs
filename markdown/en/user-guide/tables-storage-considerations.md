...
If you have been assigned the ACCOUNTADMIN role (i.e. you serve as the top-level administrator for your Snowflake account), you can use [Snowsight](/user-guide/ui-snowsight-gs#label-snowsight-getting-started-sign-in) to view data storage across your entire
account:
