...
1. Create a new role or use an existing role and grant the [Database privileges](/user-guide/security-access-control-privileges#label-database-privileges) and [View privileges](/user-guide/security-access-control-privileges#label-view-privileges).
