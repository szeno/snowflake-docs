...
Trigger an AWS Textract job. It should be followed by GetAwsTextractJobStatus processor in order to monitor job status.
...
- [org.apache.nifi.processors.aws.ml.textract.GetAwsTextractJobStatus](/user-guide/data-integration/openflow/processors/getawstextractjobstatus)
