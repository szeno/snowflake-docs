...
| [Snowflake logo in blue (no text)](/static/images/logo-snowflake-sans-text.png) | [AmazonMSKConnectionService](/user-guide/data-integration/openflow/controllers/amazonmskconnectionservice) | Provides and manages connections to AWS MSK Kafka Brokers for producer or consumer operations. |
