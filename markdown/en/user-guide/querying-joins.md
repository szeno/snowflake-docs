...
- A table.
- A [view](/user-guide/views-introduction) (materialized or non-materialized).
...
see [ASOF JOIN](/sql-reference/constructs/asof-join) and [Analyzing time-series data](/user-guide/querying-time-series-data).
