...
Triggering automated Snowpipe data loads using GCS Pub/Sub event messages is supported by Snowflake accounts hosted on [all supported cloud platforms](/user-guide/intro-cloud-platforms).
