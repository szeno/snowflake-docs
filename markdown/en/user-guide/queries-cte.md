...
think of the CTE as a temporary [view](/user-guide/views-introduction) for use in the statement that defines the
...
hierarchical data, see [Querying Hierarchical Data](/user-guide/queries-hierarchical).
...
For information about non-contiguous hierarchies, see [Querying Hierarchical Data](/user-guide/queries-hierarchical).
