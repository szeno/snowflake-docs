...
By default, when table data is unloaded to Parquet files, [fixed-point number](/sql-reference/data-types-numeric#label-data-types-for-fixed-point-numbers) columns are
unloaded as DECIMAL columns, while [floating-point number](/sql-reference/data-types-numeric#label-data-types-for-floating-point-numbers) columns are unloaded as
DOUBLE columns.
...
When [floating-point number](/sql-reference/data-types-numeric#label-data-types-for-floating-point-numbers) columns are unloaded to CSV or JSON files, Snowflake
