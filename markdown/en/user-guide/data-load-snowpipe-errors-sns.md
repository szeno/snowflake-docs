...
See [Creating a notification integration to send notifications to an Amazon SNS topic](/user-guide/notifications/creating-notification-integration-amazon-sns).
...
Create a new pipe using [CREATE PIPE](/sql-reference/sql/create-pipe). Note that configuring automated data loads (that is, auto-ingest Snowpipe)
requires additional pipe parameters. For instructions, see [Automate continuous data loading with cloud messaging](/user-guide/data-load-snowpipe-auto).
...
`ERROR_INTEGRATION = <integration_name>`
:   Name of the notification integration you created in [Create the notification integration](/user-guide/notifications/creating-notification-integration-amazon-sns#label-notification-integration-amazon-creating-integration).
...
[Create the notification integration](/user-guide/notifications/creating-notification-integration-amazon-sns#label-notification-integration-amazon-creating-integration).
