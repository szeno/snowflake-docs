...
| --- | --- |
| AI Gateway | [Snowflake logo in black (no text)](/static/images/logo-snowflake-black.png) [Preview Feature](/release-notes/preview-features) — Open  Available to all accounts.  Inference requests sent through a [Cortex AI Gateway](/user-guide/snowflake-cortex/cortex-ai-gateway). For more information, see [Add the AI Gateway](/user-guide/budgets/budget-shared-resources#label-budget-shared-resource-ai-gateway). |
