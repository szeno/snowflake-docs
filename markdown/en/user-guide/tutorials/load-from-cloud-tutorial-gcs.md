...
- You have a Google Cloud account that you can use to bulk load data from Google Cloud Storage. See
  [Bulk loading from Google Cloud Storage](/user-guide/data-load-gcs).
...
> ![SQL load from cloud template worksheet, which contains the SQL commands for this tutorial, along with descriptive comments.](/static/images/screens/load-data-from-gcs-worksheet.png)
...
1. In the open worksheet, place your cursor in the in the [CREATE STORAGE INTEGRATION](/sql-reference/sql/create-storage-integration)
   ...
   ```
2. Place your cursor in the [DESCRIBE INTEGRATION](/sql-reference/sql/desc-integration) line, specify the name of the storage
   ...
   ![Output of DESCRIBE INTEGRATION command, with the following columns: property, property_type, property_value, property_default.](/static/images/screens/desc_storage_integration_gcs_output.png)
3. Place your cursor in the [SHOW INTEGRATIONS](/sql-reference/sql/show-integrations) line and select **Run**.
   ...
   ![Output of SHOW INTEGRATIONS command, with the following columns: name, type, category, enabled, comment, created_on.](/static/images/screens/show_storage_integration_gcs_output.png)
4. Use the Google Cloud Storage Console to configure permissions to access storage buckets from your
   Cloud Storage Service Account. Follow Step 3 under [Configure an integration for Google Cloud Storage](/user-guide/data-load-gcs-config).
...
2. Return information about the stage you created:
   ...
   ![Output of SHOW STAGES command](/static/images/screens/show_stage_output_gcs.png)
...
![Copy five rows into the table.](/static/images/screens/load_from_cloud_copy_results_gcs.png)
...
![Select all the rows in the table.](/static/images/screens/load_from_cloud_query_results.png)
