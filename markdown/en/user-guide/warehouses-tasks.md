...
>     API ([Creating a warehouse](/developer-guide/snowflake-python-api/snowflake-python-managing-warehouses#label-snowflake-python-create-wh)).
...
> Snowsight:
> :   In the navigation menu, select **Compute** » **Warehouses** » *<suspended\_warehouse\_name>* » [![More options](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png)](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png) » **Resume**
>
> SQL:
...
>     API ([Performing warehouse operations](/developer-guide/snowflake-python-api/snowflake-python-managing-warehouses#label-snowflake-python-perform-wh-operations)).
...
> Snowsight:
> :   In the navigation menu, select **Compute** » **Warehouses** » *<started\_warehouse\_name>* » [![More options](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png)](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png) » **Suspend**
>
> SQL:
...
> Snowsight:
> :   In the navigation menu, select **Compute** » **Warehouses** » *<warehouse\_name>* » [![More options](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png)](/static/images/snowsight/snowsight-worksheet-explorer-ellipsis.png) » **Edit**
>
> SQL:
...
>     API ([Creating or altering a warehouse](/developer-guide/snowflake-python-api/snowflake-python-managing-warehouses#label-snowflake-python-alter-wh)).
...
see [Warehouse considerations](/user-guide/warehouses-considerations).
...
You must use the ACCOUNTADMIN role, or a role granted the relevant [warehouse privileges](/user-guide/security-access-control-privileges#label-warehouse-privileges).
...
- **QAS (Scale Factor)**, to see the scale factor of the warehouse used by Query Acceleration Service (QAS).
  See [Using the Query Acceleration Service (QAS)](/user-guide/query-acceleration-service).
- **Scaling Policy**, to see the scaling policy defined for the warehouse. See [Setting the scaling policy for a multi-cluster warehouse](/user-guide/warehouses-multicluster#label-mcw-scaling-policies).
...
- The **Warehouse Activity** section provides a graph of warehouse load over a period of time, which can help you understand why a
  query might be running slowly. See [Monitoring warehouse load](/user-guide/warehouses-load-monitoring) for more details.
