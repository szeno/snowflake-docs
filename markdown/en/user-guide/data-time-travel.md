...
![Time Travel in Continuous Data Protection lifecycle](/static/images/cdp-lifecycle-tt.png)
...
- [UNDROP <object>](/sql-reference/sql/undrop) command for tables, schemas, databases, accounts, external volumes, and tags.
  ...
  ![Time Travel SQL extensions](/static/images/data-lifecycle-time-travel2.png)
...
- The [DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-data-retention-time-in-days) object parameter can be used by users with the ACCOUNTADMIN role to set the default
...
- The [MIN\_DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-min-data-retention-time-in-days) account parameter can be set by users with the ACCOUNTADMIN role to set a minimum
...
Time Travel cannot be deactivated for an account. A user with the ACCOUNTADMIN role can set [DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-data-retention-time-in-days) to 0 at
...
A user with the ACCOUNTADMIN role can also set the [MIN\_DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-min-data-retention-time-in-days) at the account level. This parameter
...
Time Travel can be deactivated for individual databases, schemas, and tables by specifying [DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-data-retention-time-in-days) with a
...
Before setting [DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-data-retention-time-in-days) to 0 for any object, consider whether you want to deactivate Time Travel for the object,
...
- When creating a table, schema, or database, the account default can be overridden using the [DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-data-retention-time-in-days)
...
A minimum retention period can be set on the account using the [MIN\_DATA\_RETENTION\_TIME\_IN\_DAYS](/sql-reference/parameters#label-min-data-retention-time-in-days) parameter. If this parameter is
