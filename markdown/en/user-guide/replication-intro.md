...
In addition, [Snowflake Secure Data Sharing](/user-guide/secure-data-sharing-across-regions-platforms) and Database Replication enable sharing data securely across regions and cloud platforms.

## Account replication and failover/failback features

### Replication and failover/failback

[Replication](/user-guide/account-replication-intro) uses two Snowflake objects,
[replication group and failover group](/user-guide/account-replication-intro#label-replication-and-failover-groups), to replicate a group of objects with point-in-time
...
Account objects can include warehouses, users, and roles, along with databases and shares (see [Replicated objects](/user-guide/account-replication-intro#label-replicated-objects) for the full
...
[Client Redirect](/user-guide/client-redirect) provides a *connection URL* that can be used by Snowflake clients to connect to
...
shares. See [Replicated objects](/user-guide/account-replication-intro#label-replicated-objects) for the complete list of replicated objects.
