...
For more information, see [Optional: Installing multiple instances of Snowflake Connector for MySQL](/connectors/mysql6/install-snowsight#label-mysql-connector-configure-multi-instance).
